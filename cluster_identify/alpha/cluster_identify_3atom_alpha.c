		...
		for (int i2=i1+1;i2<75*(num1+num2);i2++) {
			...
			bd_id[1][2]=bd[4*i2+3];
				...
				for (int i3=i2+1;i3<75*(num1+num2);i3++) {
					...
					//		printf("%d,%d,%d,( %d, %d(%d,%d,%d), %d(%d,%d,%d) ) \n",i1+1,i2+1,i3+1,i1+1,bd[4*i2]+1,bd[4*i2+1],bd[4*i2+2],bd[4*i2+3],bd[4*i3]+1,bd[4*i3+1],bd[4*i3+2],bd[4*i3+3]);
						if(valid_count!=0){
						
							printf("%d %d %d ( %d, %d(%d,%d,%d), %d(%d,%d,%d) ) \n",i1+1,bd[4*i2]+1,bd[4*i3]+1,i1+1,bd[4*i2]+1,bd[4*i2+1],bd[4*i2+2],bd[4*i2+3],bd[4*i3]+1,bd[4*i3+1],bd[4*i3+2],bd[4*i3+3]);
